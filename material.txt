...
int main()
{
    ...
    float vertices[] = {
        ...
        Shader cube_s("resources/shader/cube.shader");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        cube_s.Bind();
        cube_s.SetUniform3fv("light.position", lightPos);
        ...
        cube_s.SetUniform3f("material.specular", 0.5f, 0.5f, 0.5f); // specular lighting doesn't have full effect on this object's material
        cube_s.SetUniform1f("material.shininess", 32.0f);
